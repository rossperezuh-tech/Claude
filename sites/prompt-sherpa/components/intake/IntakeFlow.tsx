...
export function IntakeFlow() {
  ...
  function downloadSummary() {
    ...
    a.download = `sherpa-intake-${Date.now()}.txt`;
    a.click();
    showToast("Downloaded");
  }

  function emailSummary() {
    const s = encodeURIComponent("Build intake — The Prompt Sherpa");
    const b = encodeURIComponent(
      buildSummary(data) +
        "\n\n(Reminder: attach any sketches, notes, or examples mentioned above.)"
    );
  ...
  return (
    <div className="min-h-screen lg:grid lg:grid-cols-[320px_1fr]">
      ...
      <aside className="hidden border-r border-line bg-surface/60 lg:flex lg:flex-col">
        <div className="sticky top-0 flex h-screen flex-col p-8">
              ...
              return (
                <button
                  ...
                  className={`flex w-full items-center gap-3 rounded-[10px] px-3 py-2.5 text-left text-[14px] transition-colors ${
                    active
                      ? "bg-lime-soft font-semibold text-lime-ink"
                      : "text-muted hover:bg-mist disabled:opacity-60"
                  }`}
                >
                  <span
          ...
          <div className="space-y-4 text-[12.5px] text-faint">
            ...
            >
              <span className="h-1.5 w-1.5 rounded-full bg-lime" /> Saved
            </div>
            <p>Your answers save automatically as you go.</p>
            <p className="border-t border-line pt-4">
              The Prompt Sherpa · Claude consulting &amp; Claude Code builds
      ...
      <div className="mx-auto w-full max-w-[720px] px-5 pb-28">
        {/* mobile top bar */}
        <div className="sticky top-0 z-20 -mx-5 bg-gradient-to-b from-mist from-[78%] to-transparent px-5 pb-4 pt-5 lg:hidden">
        ...
        <div className="mb-8 mt-2 lg:mt-10">
          <div className="h-[3px] overflow-hidden rounded-full bg-line">
            <div
              className="h-full rounded-full bg-lime transition-[width] duration-500 [transition-timing-function:cubic-bezier(.3,.8,.3,1)]"
        ...
        {!loaded ? null : step === 0 ? (
          ...
          <div key="intro" className="step-enter">
            <div className="pb-2 pt-5">
              <div className="eyebrow mb-4">Build Intake</div>
              <h1 className="mb-4 font-display text-[clamp(30px,5.4vw,42px)] font-bold leading-[1.05] tracking-[-1.2px]">
                Tell us about your{" "}
                <em className="not-italic text-lime-ink">idea</em> or business.
              </h1>
              <div className="mt-6 flex items-start gap-3 rounded-xl2 border border-line bg-surface p-[16px_18px] text-[14px] text-muted shadow-card">
                <svg
                  viewBox="0 0 24 24"
                  className="mt-px h-[18px] w-[18px] shrink-0 fill-none stroke-lime"
                  strokeWidth={1.8}
                >
                ...
                <span>
                  Rough is fine. You don&apos;t need a business plan or any
                  technical knowledge — describe things the way you&apos;d
                  tell a friend.
                </span>
              </div>
            </div>
          ...
          <div key={step} className="step-enter">
            <div className="mb-7">
              ...
              <h2 className="font-display text-[25px] font-bold leading-[1.12] tracking-[-0.6px]">
          ...
          <div key="review" className="step-enter">
            <div className="mb-7">
              ...
              <p className="mt-2 text-[14.5px] text-muted">
                Here&apos;s your idea, laid out. Go back to edit anything, or
                fire it over when you&apos;re ready.
              </p>
            </div>
